...
const char MODE_ANIMATION_GROWCUBE = 1;
const char MODE_ANIMATION_FUNNYTUBE = 2;
const char MODE_ANIMATION_FUNNEL = 3;
const char MODE_ANIMATION_FUNNELGROW = 4;
